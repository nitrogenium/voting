...
@section ('content')
    ...
    <div class="mt-5">
        ...
        <a type="button" href="{{route('index')}}"
                       class="bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-md text-white  focus:outline-none focus:ring-2 focus:ring-offset-2">
